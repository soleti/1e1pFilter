...
bool GeometryHelper::onSegment(std::vector<double> p, std::vector<double> q,
                               std::vector<double> r) {
...
// 1 --> Clockwise
// 2 --> Counterclockwise
int GeometryHelper::orientation(std::vector<double> p, std::vector<double> q,
                                std::vector<double> r) {
...
// and 'p2q2' intersect.
bool GeometryHelper::doIntersect(std::vector<double> p1, std::vector<double> q1,
...
// Returns true if the std::vector< double > p lies inside the polygon[] with n
// vertices
bool GeometryHelper::isInside(std::vector<std::vector<double>> &polygon,
                              std::vector<double> &p) {
  ...
  do {
    ...
    if (doIntersect(polygon[i], polygon[next], p, extreme)) {
      // If the std::vector< double > 'p' is colinear with line segment
      // 'i-next',
