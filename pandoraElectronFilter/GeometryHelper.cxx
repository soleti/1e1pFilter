...
///\TODO
// WOW these two functions need to be cleaned up and commented!
bool GeometryHelper::withinRectangle(std::vector<std::vector<double>> &points,
  ...
  bool is_below_m1_top =
      point[1] < m1_top * (point[0] - points[1][0]) + points[1][1];
  bool is_below_m2_top =
      point[1] < m2_top * (point[0] - points[1][0]) + points[1][1];
  bool is_above_m1_bottom =
      point[1] > m1_bottom * (point[0] - points[2][0]) + points[2][1];
  bool is_above_m2_bottom =
      point[1] > m2_bottom * (point[0] - points[2][0]) + points[2][1];

  return is_below_m1_top and is_below_m2_top and is_above_m2_bottom and
         is_above_m1_bottom;
}
