...
namespace lee {
  ...
  void ElectronEventSelectionAlg::GetRecoToTrueMatches(art::Event const & e, std::string _pfp_producer, std::string _spacepointLabel, std::string _geantModuleLabel, std::string _hitfinderLabel, lar_pandora::MCParticlesToPFParticles &matchedParticles, lar_pandora::MCParticlesToHits &matchedParticleHits) {
  ...
  void ElectronEventSelectionAlg::GetRecoToTrueMatches(const lar_pandora::PFParticlesToHits &recoParticlesToHits, const lar_pandora::HitsToMCParticles &trueHitsToParticles, lar_pandora::MCParticlesToPFParticles &matchedParticles, lar_pandora::MCParticlesToHits &matchedHits)
  {
  ...
  //___________________________________________________________________________________________________
  void ElectronEventSelectionAlg::GetRecoToTrueMatches(const lar_pandora::PFParticlesToHits &recoParticlesToHits,const lar_pandora::HitsToMCParticles &trueHitsToParticles, lar_pandora::MCParticlesToPFParticles &matchedParticles, lar_pandora::MCParticlesToHits &matchedHits, PFParticleSet &vetoReco, MCParticleSet &vetoTrue, bool _recursiveMatching)
  {
  ...
  bool ElectronEventSelectionAlg::is_dirt(const std::vector<double> & x) const {
  ...
  void ElectronEventSelectionAlg::traversePFParticleTree(const art::ValidHandle<std::vector<recob::PFParticle> > pfparticles, size_t top_index, std::vector<size_t> & unordered_daugthers )
  {
  ...
  TVector3 ElectronEventSelectionAlg::calculateChargeCenter(size_t top_particle_index, const art::ValidHandle<std::vector<recob::PFParticle> > pfparticles, const art::Event & evt)
  {
    ...
    art::FindManyP<recob::SpacePoint > spcpnts_per_pfpart ( pfparticles, evt, _pfp_producer );
  ...
  bool ElectronEventSelectionAlg::opticalfilter(size_t ipf, const std::vector<recob::PFParticle> & pfparticles, TVector3 _this_center_of_charge, int &_selected_flash, const art::Event & evt)
  {
  ...
  bool ElectronEventSelectionAlg::eventSelected(const art::Event & evt)
  {
    ...
    for (auto & _i_primary : _primary_indexes ) {
      ...
      bool _flash_passed = opticalfilter(_i_primary, * pfparticle_handle, _center_of_charge[_i_primary], _selected_flash, evt);
