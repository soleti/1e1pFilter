    ...
    std::string _pfp_producer)
{
  ...
  auto const &spcpnts_handle = evt.getValidHandle<std::vector<recob::SpacePoint>>(_pfp_producer);
  art::FindManyP<recob::Hit> hits_per_spcpnts(spcpnts_handle, evt, _pfp_producer);
