...
SpaceChargeMicroBooNE::SpaceChargeMicroBooNE() {
  Configure("source/SCEoffsets_MicroBooNE_E273.root");
}
...
std::vector<double> SpaceChargeMicroBooNE::GetPosOffsets(double xVal,
                                                         double yVal,
                                                         double zVal) const {
...
std::vector<double>
SpaceChargeMicroBooNE::GetPosOffsetsParametric(double xVal, double yVal,
                                               double zVal) const {
  ...
  thePosOffsetsParametric.push_back(
      GetOnePosOffsetParametric(xValNew, yValNew, zValNew, "X"));
  thePosOffsetsParametric.push_back(
      GetOnePosOffsetParametric(xValNew, yValNew, zValNew, "Y"));
  thePosOffsetsParametric.push_back(
      GetOnePosOffsetParametric(xValNew, yValNew, zValNew, "Z"));
...
/// axis
double SpaceChargeMicroBooNE::GetOnePosOffsetParametric(
    double xValNew, double yValNew, double zValNew, std::string axis) const {
  double parA[6][7];
  double parB[6];
...
std::vector<double> SpaceChargeMicroBooNE::GetEfieldOffsets(double xVal,
                                                            double yVal,
                                                            double zVal) const {
...
std::vector<double>
SpaceChargeMicroBooNE::GetEfieldOffsetsParametric(double xVal, double yVal,
                                                  double zVal) const {
...
/// axis
double SpaceChargeMicroBooNE::GetOneEfieldOffsetParametric(
    double xValNew, double yValNew, double zValNew, std::string axis) const {
  double parA[6][7];
  double parB[6];
...
//----------------------------------------------------------------------------
/// Check to see if point is inside boundaries of map (allow to go slightly out
/// of range)
bool SpaceChargeMicroBooNE::IsInsideBoundaries(double xVal, double yVal,
                                               double zVal) const {
  bool isInside = true;

  if ((xVal < 0.0) || (xVal > 260.0) || (yVal < -120.0) || (yVal > 120.0) ||
      (zVal < 0.0) || (zVal > 1050.0)) {
    isInside = false;
  }
